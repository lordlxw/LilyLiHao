        ...
        if (self.socketMain) {
          ...
          self.socketMain.onmessage = function (msg) {
            ...
            if (msgJson) {
              switch (msgJson.dataType) {
                ...
                case 'jiaogeweiyueNotice_bond_1':
                  ...
                  <div class="notify notify-dd-red">
                    ...
                    <dl>
                      <dt>违约方</dt>
                      <dd>${configUtil.funcKeyValue(msgJson.data.weiyuePerson ? msgJson.data.weiyuePerson.toString() : '', "breakTypeOptions")}</dd>
                    </dl>
                    <dl>
                      <dt>违约量</dt>
              ...
              self.socketMain.send(JSON.stringify({ "dataType": "ack", "data": { "dataKey": msgJson.dataKey, "dataType": msgJson.dataType } }))
            }
          }
          // 关闭事件
