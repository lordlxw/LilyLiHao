...
<template>
  <div class="content">
    <div class="list">
      <div class="do">
        <el-button type="default" v-if="setAuth('inquiry:insert')" @click="handleAddInquiry">添加</el-button>
      </div>
      <div class="table mt10">
        <el-table v-loading="loading" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
          :height="height" border row-key="userTradeId" default-expand-all
          :tree-props="{ children: 'children', hasChildren: 'hasChildren' }"
          header-row-style="height:30px;line-height:30px;" header-cell-style="background:#f8f8f8;" :key="Math.random()"
          :row-class-name="tableRowClassName" :cell-style="cellStyle" :span-method="objectSpanMethod"
          ...
          <el-table-column fixed="right" align="center" label="操作" width="220">
            <template slot-scope="scope">
              ...
              > -->
              <el-button type="text" v-if="setAuth('inquiry:edit') &&
          ...
          scope.row.youxianLevel === 2
            ...
            : scope.row.youxianLevel === 1
              ...
              <el-button @click="handleDealClick(scope.row)" type="text" size="small" v-if="['1', '4', '8', '10'].indexOf(scope.row.status.toString()) !==
          -1 &&
          ...
          ">取消</el-button>
              ...
              <el-button @click="handleEnquiryDifficultClick(scope.row)" type="text" size="small" v-if="[1, 4, 8].indexOf(scope.row.status) !== -1 &&
          setAuth('inquiry:difficult')
          " class="ml10">难成</el-button>
              <el-button type="text" v-if="setAuth('inquiry:difficultcanncel') &&
          [5, 19].indexOf(scope.row.status) !== -1
          " @click="handleDifficultNewEnqury(scope.row)">新建</el-button>
              <el-popover v-if="setAuth('inquiry:difficultcanncel') && scope.row.status === 19
          ...
          ">取消</el-button>
              ...
              <el-button type="text" v-if="setAuth('inquiry:accept') &&
          ...
          scope.row.youxianLevel === 2
            ...
            : scope.row.youxianLevel === 1
              ...
              <el-popover v-if="['0', '1', '4'].indexOf(scope.row.status.toString()) !== -1 &&
          ...
          ">取消</el-button>
              ...
              <el-popover v-if="['7'].indexOf(scope.row.status.toString()) !== -1 &&
          ...
          ">取消</el-button>
              ...
              <el-popover v-if="['9'].indexOf(scope.row.status.toString()) !== -1 &&
          ...
          ">取消</el-button>
              ...
              <el-popover v-if="setAuth('inquiry:breaktobeconfirm') && scope.row.status === 20
          ...
          scope.row.tscode }}？
                ...
                <el-table border :data="diffTableData" :cell-style="cellStyleUpdate">
          ...
          <el-table-column fixed="right" align="center" label="滚单成交" width="80">
            <template slot-scope="scope">
              <el-button @click="handleRollDealClick(scope.row)" type="text" size="small" v-if="['1', '3', '4', '8', '10'].indexOf(
