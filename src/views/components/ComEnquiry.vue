...
<template>
  <div class="content">
    <div class="mb10" v-if="userInfo.roleName && ['研究员'].indexOf(userInfo.roleName) !== -1">
      <account-risk-control></account-risk-control>
    </div>
    <div class="list">
      <div class="do">
        <el-button class="btn-add" type="default" v-if="setAuth('inquiry:insert')"
          @click="handleAddInquiry">添加</el-button>
      </div>
      <div class="table mt10">
        <el-table v-loading="loading" ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%"
          :height="height" row-key="userTradeId" default-expand-all
          ...
          @expand-change="handleExpandChange" @sort-change="handleSortChange">
          <!-- :key="Math.random()" -->
          ...
          <template v-for="itemHead in tableHead">
            ...
            >
              <el-table-column
                ...
                "
                :width="
                  itemHead.width ? parseInt(itemHead.width * (3 / 5)) : ''
                "
                :formatter="
              ...
              <el-table-column
                ...
                "
                :width="
                  itemHead.width ? parseInt(itemHead.width * (2 / 3)) : ''
                "
                :formatter="
                  (row, column, cellValue, index) => {
