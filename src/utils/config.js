export default {
  ...
  enquiryHead: {
    ...
    createTime: { label: '询价时间', prop: 'createTime', width: '146', align: 'left', show: true },
    price: { label: '询价', prop: 'price', width: '80', align: 'right', show: true },
    worstPrice: { label: '允许最差价格', prop: 'worstPrice', width: '100', align: 'right', show: true },
    realPrice: { label: '成交价', prop: 'realPrice', width: '90', align: 'right', show: true },
    volume: { label: '询量', prop: 'volume', width: '60', align: 'right', show: true },
    restVolume: { label: '剩余询量', prop: 'restVolume', width: '80', align: 'right', show: true },
    realVolume: { label: '成交额', prop: 'realVolume', width: '90', align: 'right', show: true },
    deliveryTime: { label: '询价交割', prop: 'deliveryTime', width: '110', align: 'left', show: true },
    realDeliveryTime: { label: '成交交割', prop: 'realDeliveryTime', width: '90', align: 'right', show: true },
    tscode: { label: '券码', prop: 'tscode', width: '80', align: 'left', show: true },
  ...
  bondsHead: {
    ...
    direction: { label: '方向', prop: 'direction', formatter: this.funcFormat, width: '100', align: 'left', show: true },
    price: { label: '成交价', prop: 'price', formatter: this.funcFormat, width: '120', align: 'right', show: true },
    volume: { label: '持仓量', prop: 'volume', width: '120', align: 'right', show: true },
    restVolume: { label: '待平量', prop: 'restVolume', width: '120', align: 'right', show: true },
    deliverySpeed: { label: '交割速度', prop: 'deliverySpeed', width: '90', align: 'left', show: false },
    deliveryTime: { label: '交割日期', prop: 'deliveryTime', formatter: this.funcFormat, width: '120', align: 'left', show: true },
    floatProfit: { label: '浮动盈亏', prop: 'floatProfit', width: '120', align: 'right', show: true },
  ...
  breakHead: {
    ...
    deliveryTime: { label: '交割日期', prop: 'deliveryTime', width: '160', align: 'left', show: true },
    weiyueAmount: { label: '违约量', prop: 'weiyueAmount', width: '140', align: 'right', show: true },
    weiyuePerson: { label: '违约方', prop: 'weiyuePerson', width: '160', align: 'left', show: true },
    marketMakerName: { label: '做市商', prop: 'marketMakerName', width: '160', align: 'left', show: true },
    jiaogeStatus: { label: '状态', prop: 'jiaogeStatus', width: '140', align: 'left', show: true },
    realTradeId: { label: '交易员id', prop: 'realTradeId', width: '120', align: 'left', show: false },
    remark: { label: '备注', prop: 'remark', width: '500', align: 'left', show: true },
    tradeNum: { label: '单据号', prop: 'tradeNum', width: '220', align: 'left', show: true },
