export default {
  ...
  enquiryHead: {
    ...
    price: { label: '询价', prop: 'price', width: '66', align: 'right', show: true },
    worstPrice: { label: '允许最差价格', prop: 'worstPrice', width: '66', align: 'right', show: true },
    realPrice: { label: '成交价', prop: 'realPrice', width: '66', align: 'right', show: true },
    volume: { label: '询量', prop: 'volume', width: '56', align: 'right', show: true },
    restVolume: { label: '剩余询量', prop: 'restVolume', width: '70', align: 'right', show: true },
    realVolume: { label: '成交额', prop: 'realVolume', width: '60', align: 'right', show: true },
    ...
    tradeTime: { label: '成交时间', prop: 'tradeTime', width: '146', align: 'left', show: true },
  ...
  bondsHead: {
    ...
    price: { label: '成交价', prop: 'price', formatter: this.funcFormat, width: '66', align: 'right', show: true },
    volume: { label: '持仓量', prop: 'volume', width: '66', align: 'right', show: true },
    restVolume: { label: '待平量', prop: 'restVolume', width: '60', align: 'right', show: true },
    deliverySpeed: { label: '交割速度', prop: 'deliverySpeed', width: '90', align: 'left', show: false },
    deliveryTime: { label: '交割日期', prop: 'deliveryTime', formatter: this.funcFormat, width: '90', align: 'left', show: true },
    floatProfit: { label: '浮动盈亏', prop: 'floatProfit', width: '90', align: 'right', show: true },
    profit: { label: '已平盈亏', prop: 'profit', width: '90', align: 'right', show: true },
