export default {
  ...
  enquiryHead: {
    ...
    createTime: { label: '询价时间', prop: 'createTime', width: '200', align: 'left', show: true },
    price: { label: '询价', prop: 'price', width: '100', align: 'right', show: true },
    ...
    volume: { label: '询量', prop: 'volume', width: '120', align: 'right', show: true },
    restVolume: { label: '剩余询量', prop: 'restVolume', width: '120', align: 'left', show: true },
    realVolume: { label: '成交额', prop: 'realVolume', width: '120', align: 'right', show: true },
    ...
    status: { label: '状态', prop: 'status', width: '100', align: 'left', show: true },
    ...
    tradeuser: { label: '交易员', prop: 'tradeuser', width: '140', align: 'left', show: true }
